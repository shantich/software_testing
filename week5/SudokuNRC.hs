...
showRow [a1,a2,a3,a4,a5,a6,a7,a8,a9] = 
 do  putChar '|'         ; putChar ' '
     ...
     putChar '|'         ; putChar ' '
     putStr (showVal a4) ; putChar ' '; putChar ' '; putChar ' '
     putStr (showVal a5) ; putChar ' '; putChar ' '; putChar ' '
...
freeAtPos s (r,c) = 
  (freeInRow s r) 
   ...
   -- !! Add intersection with NRC Grid
...
consistent s = and $
               ...
               [ subgridInjective s (r,c) | 
                    r <- [1,4,7], c <- [1,4,7]]
                -- !! Add consistency Check for NRC Grid
                ++
...
prune (r,c,v) ((x,y,zs):rest)
  ...
  -- Add pruning for same NRC Block
...
----------------------------
-- !! Check if in same NRC Block
----------------------------
sameblocknrc :: (Row,Column) -> (Row,Column) -> Bool
sameblocknrc (r,c) (x,y) = bl' r == bl' x && bl' c == bl' y
